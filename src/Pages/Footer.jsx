    ...
    <>
      <div className=" dark:bg-gray-950 py-6 relative overflow-hidden">
        ...
        <div className="container mx-auto px-3 md:px-0">
          <div className="grid md:grid-cols-3 pt-3 py-5 bg-white/80 backdrop-blur-sm ml-[50px] rounded-t-xl mr-[50px] mt-[40px]">
          ...
          <div className="ml-[50px] mr-[50px]">
            <div className="text-center py-5 bg-[rgb(78,157,164)] border-t-2 border-gray-300/50 bg-primary text-white z-[9999] ">
              @copyright 2024 All rights reserved || Made with ❤️ by Rohit
            </div>
          </div>
        </div>
      </div>
